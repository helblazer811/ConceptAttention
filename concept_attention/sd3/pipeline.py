...
class CustomStableDiffusion3Pipeline(
    ...
    def encode_concepts(
        ...
        # Join the concepts together into a prompt
        ...
        prompt_embeds = prompt_embeds[
            :, : len(concepts) + 1
        ]  # Leave room for a padding token
    ...
    def __call__(
        ...
        # Array for saving the cross attention maps
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred, current_concept_attention_outputs = self.transformer(
        ...
        return StableDiffusion3PipelineOutput(images=image), concept_attention_outputs
